...
model = load_model('car_crash_detection_model_improved_with_f1.keras', custom_objects={'f1_score': f1_score})
...
while True:
    ...
    for output in outputs:
        for detection in output:
            ...
            if confidence > 0.6 and class_id in VEHICLE_IDS:  # Confidence threshold and vehicle class
    ...
    for i in range(len(boxes)):
        if i in indexes:
            ...
            if severity > 0:
                ...
                # Create label with color and severity
